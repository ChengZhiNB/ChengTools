...
public class multi {
    ...
    static HashMap<String, Integer> TimeMessageIntTemp = new HashMap<>();

    public static void SetTimeMessageIntTemp(String String1, Integer Int1) {
        TimeMessageIntTemp.put(String1,Int1);
    }

    public static Integer GetTimeMessageTemp(String String1) {
        return TimeMessageIntTemp.get(String1);
    }
    ...
    public static void KickGui(Player player) {
        ...
        Objects.requireNonNull(Bk_Meta).setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e这只是一个边框"));
        ...
        Objects.requireNonNull(Gb_Meta).setDisplayName(ChatColor.translateAlternateColorCodes('&',"&c关闭菜单"));
